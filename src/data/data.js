...
export const cooperativaData = {
  ...
  mainPageLink: "/", // Puedes cambiarlo a una URL real o usar '/' si es la única página.
  ...
  photos: [
    { name: 'Flota', url: '/assets/imagen/taxi.png' }, // Si tienes otras fotos, mantenlas
    { name: 'Equipo', url: photoEquipo }, // <-- AGREGAR ESTO
  ],
